...
namespace Lights {
	...
	struct DirectionalLight
	{
        ...
        XVector ambient;	//环境光
        XVector diffuse;	//漫反射光
        XVector specular;	//高光
        XVector direction;	//光照方向
	};
	...
	inline void ComputeDirectionalLight(
        ...
        XVector normal,					//顶点法线
        XVector toEye,					//顶点到眼睛的向量
        XVector& ambient,				//计算结果:环境光
        XVector& diffuse,				//计算结果:漫反射光
        XVector& spec)					//计算结果:高光
	{
		// 结果初始化为0
