...
//{
//    UNREFERENCED_PARAMETER(hPrevInstance);	//作用：告诉编译器，已经使用了该变量，不必检测警告！
...
//    wcex.lpszClassName = L"g_title.c_str()";
...
//    HWND g_hWnd = CreateWindowExA(WS_EX_DLGMODALFRAME,g_title.c_str(), g_title.c_str(), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT,
